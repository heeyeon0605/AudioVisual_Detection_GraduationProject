...
def KLDivergence(img, audio):
    ...
    cs = nn.KLDivLoss(reduction='batchmean')
...
def label_train(data_set, params, newmodel, audio):
    ...
    cs_output1 = KLDivergence(output1, audio)
    cs_output2 = KLDivergence(output2, audio)
    cs_output3 = KLDivergence(output3, audio)
    cs_output4 = KLDivergence(output4, audio)
    cs_output5 = KLDivergence(output5, audio)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--log_dir', default='./train_kl_logs', type=str)
